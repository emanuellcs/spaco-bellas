        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed" style={{ color: COLORS.textLight }}>
              Programa VIP Bellas: beleza completa, bem-estar e acolhimento emocional em um único lugar — com economia real e pertencimento.
            </p>
          </div>

          {/* Coluna 2: Navegação */}
          <div>
            <h4 className="text-base font-semibold mb-4" style={{ color: COLORS.gold }}>
              Navegação
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <Phone size={16} className="mt-0.5 flex-shrink-0" style={{ color: COLORS.lilac }} />
                <a
                  href={buildWAUrl("Olá! Quero conhecer o Programa Mulheres VIP Bellas.")}
                  className="hover:opacity-80 transition"
                  style={{ color: COLORS.textLight }}
                >
                  (11) 97682-0135
              ...
              <li className="flex items-start gap-2">
                <Mail size={16} className="mt-0.5 flex-shrink-0" style={{ color: COLORS.lilac }} />
                <a
              ...
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-0.5 flex-shrink-0" style={{ color: COLORS.lilac }} />
                <span style={{ color: COLORS.textLight }}>
                  R. Antônio Fortunato, 678 - Burgo Paulista, São Paulo - SP
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Clock size={16} className="mt-0.5 flex-shrink-0" style={{ color: COLORS.lilac }} />
                <span style={{ color: COLORS.textLight }}>
                  Seg - Sáb: 9h às 19h<br />Dom: Fechado
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border hover:bg-white/10 transition"
                style={{ 
                  borderColor: 'rgba(255,255,255,0.2)',
                  color: COLORS.text
                }}
